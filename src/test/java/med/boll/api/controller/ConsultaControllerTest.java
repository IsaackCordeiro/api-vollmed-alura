...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 400 quando informação estão inválidas")
    @WithMockUser
    ...
    void agendarCenario2() throws Exception {
        ...
        // Avisa o spring que ao fazer o mock de agenda de Consultas e usar o método agendar,
        // retornar DadosDetalhamentoConsulta usando a Biblioteca Mokito
        ...
        // Confere se o status da requisição de teste é OK (cod. 200)
        ...
        // Confere se o json retornado da requisição é igual ao jsonEsperado
